...
@section('title', getTranslation('ProcessSection'))
@section('content')
    <div class="content">
        <div class="row">
            <div class="col-xl-12">
                        ...
                        <table class="table text-nowrap table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">{{ getTranslation('processsections_title') }}</th>
                                    <th class="text-center">{{ getTranslation('processsections_description') }}</th>
                                    <th class="text-center">{{ getTranslation('processsections_photo') }}</th>
                                    <th class="text-center">{{ getTranslation('processsections_order') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-inline-flex gap-2">
                                                <a href="{{ route('processsections.show', $model->id) }}"
                                                    class="btn btn-outline-info">
                                                    <i class="icon-eye8"></i>
                                                </a>
                                                <a href="{{ route('processsections.edit', $model->id) }}"
                                                    class="btn btn-outline-success ml-2">
                                                    <i class="icon-pencil3"></i>
                                                </a>
                                                <a target="_blank" href="{{ route('history.show', ['model' => 'ProcessSection', 'id' => $model->id]) }}"
                                            ...
                                            <div id="delete_modal_{{ $model->id }}" class="modal fade" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('processsections.destroy', $model->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
