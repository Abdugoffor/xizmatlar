...
@section('title', getTranslation('Редактировать processsection'))
@section('content')
    <div class="content">
        <div class="d-inline-flex gap-2">
            <a href="{{ route('processsections.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="card mt-2">
            <div class="card-body">
                <form action="{{ route('processsections.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <fieldset class="mb-3">
                        <legend class="text-uppercase font-size-sm font-weight-bold">
                            {{ getTranslation('processsection') }}
                        </legend>
