...
@section('title', getTranslation('AboutStatistic'))
@section('content')
    <div class="content">
        <div class="row">
            <div class="col-xl-12">
                        ...
                        <table class="table text-nowrap table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">{{ getTranslation('aboutstatistics_title') }}</th>
                                    <th class="text-center">{{ getTranslation('aboutstatistics_description') }}</th>
                                    <th class="text-center">{{ getTranslation('aboutstatistics_text') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-inline-flex gap-2">
                                                <a href="{{ route('aboutstatistics.show', $model->id) }}"
                                                    class="btn btn-outline-info">
                                                    <i class="icon-eye8"></i>
                                                </a>
                                                <a href="{{ route('aboutstatistics.edit', $model->id) }}"
                                            ...
                                            <div id="delete_modal_{{ $model->id }}" class="modal fade" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('aboutstatistics.destroy', $model->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
