...
@section('title', getTranslation('Создать aboutcompany'))
@section('content')
    <div class="content">
        ...
        <div class="card mt-2">
            <div class="card-body">
                <form action="{{ route('aboutcompanies.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        @foreach (getLanguage() as $lang)
                                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('section_label.' . $lang->name) }}"
                                        ...
                                        @foreach (getLanguage() as $lang)
                                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('block_label1.' . $lang->name) }}"
                                                       placeholder="{{ $lang->name }}">
                                        ...
                                        @foreach (getLanguage() as $lang)
                                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('block_title1.' . $lang->name) }}"
                                                       placeholder="{{ $lang->name }}">
                                        ...
                                        @foreach (getLanguage() as $lang)
                                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('block_label2.' . $lang->name) }}"
                                                       placeholder="{{ $lang->name }}">
                                        ...
                                        @foreach (getLanguage() as $lang)
                                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('block_title2.' . $lang->name) }}"
                                                       placeholder="{{ $lang->name }}">
                                        ...
                                        @foreach (getLanguage() as $lang)
                                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('founder_name.' . $lang->name) }}"
                                                       placeholder="{{ $lang->name }}">
                                        ...
                                        @foreach (getLanguage() as $lang)
                                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('founder_position.' . $lang->name) }}"
                                                       placeholder="{{ $lang->name }}">
