...
@section('title', getTranslation('Sertificate'))
@section('content')
    <div class="content">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body d-lg-flex align-items-lg-center justify-content-lg-between flex-lg-wrap">
                        ...
                        <div>
                            <a href="{{ route('sertificates.create') }}" class="btn btn-teal">
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap table-bordered">
                            <thead>
                                ...
                                <form action="{{ route('sertificates.index') }}" method="get">
                                    <tr>
                            ...
                            <td>@if($model->file) <a href="{{ asset($model->file) }}" target="_blank">{{ getTranslation('Open file') }}</a> @else - @endif</td>

                                        <td>
                                            <div class="d-inline-flex gap-2">
                                                <a href="{{ route('sertificates.show', $model->id) }}" class="btn btn-outline-info">
                                                    <i class="icon-eye8"></i>
                                                </a>
                                            ...
                                            <div id="delete_modal_{{ $model->id }}" class="modal fade" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('sertificates.destroy', $model->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
