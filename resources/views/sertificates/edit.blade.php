...
@section('title', getTranslation('Редактировать sertificate'))
@section('content')
    <div class="content">
        ...
        <div class="card mt-2">
            <div class="card-body">
                <form action="{{ route('sertificates.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <fieldset class="mb-3">
                        <legend class="text-uppercase font-size-sm font-weight-bold">
                            {{ getTranslation('sertificate') }}
                        </legend>
                                ...
                                <div class="form-group">
                                    ...
                                    @if(!empty($model->file))
                                        ...
                                        @if(in_array($extension, ['jpg', 'jpeg', 'png', 'gif', 'webp']))
                                            <div class="mb-2">
                                                <img src="{{ asset($model->file) }}" alt="file" style="max-height:120px; border-radius:8px;">
                                            </div>
                                        @endif
                                    @endif
