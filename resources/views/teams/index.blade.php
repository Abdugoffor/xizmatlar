                            ...
                            <tbody>
                                @foreach ($models as $model)
                                    <tr>
                                        ...
                                        <td> <a href="{{ $model->linked }}" target="_blank">{{ $model->linked }}</a></td>
                                        <td> <a href="{{ $model->telegram }}" target="_blank">{{ $model->telegram }}</a></td>
                                        <td> <a href="{{ $model->watsapp }}" target="_blank">{{ $model->watsapp }}</a></td>
                                        <td> <a href="{{ $model->facebook }}" target="_blank">{{ $model->facebook }}</a></td>
                                        <td> <a href="{{ $model->email }}" target="_blank">{{ $model->email }}</a></td>
                                        <td>
                                            @if($model->is_active)
                                        ...
                                        <td>
                                            <div class="d-inline-flex gap-2">
                                                ...
                                                <a target="_blank"
                                                    href="{{ route('history.show', ['model' => 'Team', 'id' => $model->id]) }}"
