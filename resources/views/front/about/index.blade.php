                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="list-inner-wrap mb-lg-0 mb-4">
                                            ...
                                            <li>
                                                <img src="assets/img/icon/check.png" alt="img" />Combine Fitness and
                                            </li>
                                            <li>
                                                <img src="assets/img/icon/check.png" alt="img" />Best
                                                Solutions
                        ...
                        <div class="single-progressbar">
                            ...
                            <div class="progress-item" id="progress-running">
                                <div class="progress-bg">
                                    <div id="progress" class="progress-rate" data-value="85"></div>
                                </div>
                            </div>
                        </div>
                        <div class="single-progressbar">
                            ...
                            <div class="progress-item" id="progress-running-1">
                                <div class="progress-bg">
                                    <div id="progress-1" class="progress-rate" data-value="80"></div>
                                </div>
                            </div>
                        </div>
                        <div class="single-progressbar">
                            ...
                            <div class="progress-item" id="progress-running-2">
                                <div class="progress-bg">
                                    <div id="progress-2" class="progress-rate" data-value="90"></div>
                                </div>
                            </div>
                        </div>
                        <div class="single-progressbar">
                            ...
                            <div class="progress-item mb-0" id="progress-running-3">
                                <div class="progress-bg">
                                    <div id="progress-3" class="progress-rate" data-value="75"></div>
                                </div>
                            </div>
                        </div>
                    </div>
