...
@section('title', getTranslation('Редактировать carousel'))
@section('content')
    <div class="content">
        <div class="d-inline-flex gap-2">
            <a href="{{ route('carousels.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="card mt-2">
            <div class="card-body">
                <form action="{{ route('carousels.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <fieldset class="mb-3">
                        <legend class="text-uppercase font-size-sm font-weight-bold">
                            {{ getTranslation('carousel') }}
                        </legend>
                        <div class="form-group row">
                            <div class="card-body">

                                <div class="form-group">
                                    <label class="form-label">{{ getTranslation('carousels_title') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="form-label">{{ getTranslation('carousels_description') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="col-form-label">{{ getTranslation('carousels_photo') }}</label>
