...
@section('title', getTranslation('Carousel'))
@section('content')
    <div class="content">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body d-lg-flex align-items-lg-center justify-content-lg-between flex-lg-wrap">
                        ...
                        <div>
                            <a href="{{ route('carousels.create') }}" class="btn btn-teal">
                        ...
                        <table class="table text-nowrap table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">{{ getTranslation('carousels_title') }}</th>
                                    <th class="text-center">{{ getTranslation('carousels_description') }}</th>
                                    <th class="text-center">{{ getTranslation('carousels_photo') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            <input type="text" class="form-control" name="title"
                                                placeholder="{{ getTranslation('carousels_title') }}"
                                                value="{{ old('title', request('title')) }}">
                                        </th>
                                        <th class="text-center">
                                            <input type="text" class="form-control" name="description"
                                                placeholder="{{ getTranslation('carousels_description') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-inline-flex gap-2">
                                                <a href="{{ route('carousels.show', $model->id) }}"
                                                    class="btn btn-outline-info">
                                                    <i class="icon-eye8"></i>
                                                </a>
                                                <a href="{{ route('carousels.edit', $model->id) }}"
                                                ...
                                                <a target="_blank" href="{{ route('history.show', ['model' => 'Carousel', 'id' => $model->id]) }}"
                                            ...
                                            <div id="delete_modal_{{ $model->id }}" class="modal fade" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('carousels.destroy', $model->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
