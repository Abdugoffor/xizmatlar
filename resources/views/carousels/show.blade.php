...
@section('title', getTranslation('carousel детали'))
@section('content')
    <div class="content">
        <div class="d-inline-flex gap-2">
            ...
            <a href="{{ route('carousels.edit', $model->id) }}" class="btn btn-outline-success ml-2">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <th style="width:20%;vertical-align:top">{{ getTranslation('carousels_title') }}</th>
                            <td>
                        ...
                        <tr>
                            <th style="width:20%;vertical-align:top">{{ getTranslation('carousels_description') }}</th>
                            <td>
                        ...
                        <tr>
                            <th style="width:20%">{{ getTranslation('carousels_photo') }}</th>
                            <td>
                                @if($model->photo)
