...
@section('title', getTranslation('AboutPageSkills'))
@section('content')
    <div class="content">
        <div class="row">
            <div class="col-xl-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-inline-flex gap-2">
                                                <a href="{{ route('skillsoptions.index') }}"
                                                    class="btn btn-outline-info">
                                                    <i class="icon-list"></i>
                                                </a>
                                                <a href="{{ route('aboutpageskills.show', $model->id) }}"
                                                    class="btn btn-outline-info ml-2">
                                                    <i class="icon-eye8"></i>
                                                </a>
                                                <a href="{{ route('aboutpageskills.edit', $model->id) }}"
                                            ...
                                            <div id="delete_modal_{{ $model->id }}" class="modal fade" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('aboutpageskills.destroy', $model->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
