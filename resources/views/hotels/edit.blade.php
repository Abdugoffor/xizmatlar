...
@section('title', getTranslation('Редактировать hotel'))
@section('content')
    <div class="content">
        ...
        <div class="card mt-2">
            <div class="card-body">
                <form action="{{ route('hotels.update', $model->id, false) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control"
                                           name="is_active"
                                           value="{{ old('is_active', $model->is_active ?? '') }}"
