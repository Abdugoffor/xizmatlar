...
@section('title', getTranslation('Video'))
@section('content')
    <div class="content">
        <div class="row">
            <div class="col-xl-12">
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap table-bordered">
                            <thead>
                                ...
                                <th class="text-center">{{ getTranslation('home video') }}</th>
                            ...
                            <td>@if($model->home_video) <a href="{{ asset($model->home_video) }}" target="_blank">{{ getTranslation('Open file') }}</a> @else - @endif</td>

                                        <td>
                                            <div class="d-inline-flex gap-2">
                                                <a href="{{ route('videos.show', $model->id) }}" class="btn btn-outline-info">
                                                    <i class="icon-eye8"></i>
                                                </a>
                                            ...
                                            <div id="delete_modal_{{ $model->id }}" class="modal fade" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('videos.destroy', $model->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
