...
@section('title', getTranslation('Portfolio'))
@section('content')
    <div class="content">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body d-lg-flex align-items-lg-center justify-content-lg-between flex-lg-wrap">
                        ...
                        <div>
                            <a href="{{ route('portfolios.create') }}" class="btn btn-teal">
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap table-bordered">
                            <thead>
                                ...
                                <form action="{{ route('portfolios.index') }}" method="get">
                                    <tr>
                            ...
                            <td>{{ $model->is_active ? '1' : '0' }}</td>
                                        ...
                                        <td>
                                            <div class="d-inline-flex gap-2">
                                                <a href="{{ route('portfolios.show', $model->id) }}" class="btn btn-outline-info">
                                                    <i class="icon-eye8"></i>
                                                </a>
                                                <a href="{{ route('portfolios.edit', $model->id) }}" class="btn btn-outline-success ml-2">
                                            ...
                                            <div id="delete_modal_{{ $model->id }}" class="modal fade" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('portfolios.destroy', $model->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
