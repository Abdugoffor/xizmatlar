...
@section('title', getTranslation('Редактировать portfolio'))
@section('content')
    <div class="content">
        ...
        <div class="card mt-2">
            <div class="card-body">
                <form action="{{ route('portfolios.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-group row">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label class="form-label">{{ getTranslation('portfolios_title') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="form-label">{{ getTranslation('portfolios_description') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="col-form-label">{{ getTranslation('portfolios_photo') }}</label>
