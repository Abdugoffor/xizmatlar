            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body d-lg-flex align-items-lg-center justify-content-lg-between flex-lg-wrap">
                        ...
                        <div>
                            <a href="{{ route('blogs.create') }}" class="btn btn-teal">
                        ...
                        <table class="table text-nowrap table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">{{ getTranslation('blogs_title') }}</th>
                                    <th class="text-center">{{ getTranslation('blogs_description') }}</th>
                                    <th class="text-center">{{ getTranslation('blogs_photo') }}</th>
                                    <th class="text-center">{{ getTranslation('blogs_is active') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            <input type="text" class="form-control" name="title"
                                                placeholder="{{ getTranslation('blogs_title') }}"
                                                value="{{ old('title', request('title')) }}">
                                        </th>
                                        <th class="text-center">
                                            <input type="text" class="form-control" name="description"
                                                placeholder="{{ getTranslation('blogs_description') }}"
                                        ...
                                        <th class="text-center">
                                            <input type="text" class="form-control" name="is_active"
                                                placeholder="{{ getTranslation('blogs_is active') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-inline-flex gap-2">
                                                <a href="{{ route('blogs.show', $model->id) }}" class="btn btn-outline-info">
                                                    <i class="icon-eye8"></i>
                                                </a>
                                                <a href="{{ route('blogs.edit', $model->id) }}"
                                                ...
                                                <a target="_blank"
                                                    href="{{ route('history.show', ['model' => 'Blog', 'id' => $model->id]) }}"
                                            ...
                                            <div id="delete_modal_{{ $model->id }}" class="modal fade" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('blogs.destroy', $model->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
