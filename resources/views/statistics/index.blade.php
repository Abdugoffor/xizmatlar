            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body d-lg-flex align-items-lg-center justify-content-lg-between flex-lg-wrap">
                        ...
                        <div>
                            <a href="{{ route('statistics.create') }}" class="btn btn-teal">
                            ...
                            <td>{{ $model->is_active ? '1' : '0' }}</td>
                                        ...
                                        <td>
                                            <div class="d-inline-flex gap-2">
                                                <a href="{{ route('statistics.show', $model->id) }}" class="btn btn-outline-info">
                                                    <i class="icon-eye8"></i>
                                                </a>
                                                <a href="{{ route('statistics.edit', $model->id) }}" class="btn btn-outline-success ml-2">
                                            ...
                                            <div id="delete_modal_{{ $model->id }}" class="modal fade" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('statistics.destroy', $model->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
