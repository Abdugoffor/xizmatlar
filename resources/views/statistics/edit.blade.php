...
@section('title', getTranslation('Редактировать statistic'))
@section('content')
    <div class="content">
        ...
        <div class="card mt-2">
            <div class="card-body">
                <form action="{{ route('statistics.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <fieldset class="mb-3">
                        <legend class="text-uppercase font-size-sm font-weight-bold">
                            {{ getTranslation('statistic') }}
                        </legend>
                        <div class="form-group row">
                            <div class="card-body">

                                <div class="form-group">
                                    <label class="form-label">{{ getTranslation('statistics_title') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="form-label">{{ getTranslation('statistics_description') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="col-form-label">{{ getTranslation('statistics_photo') }}</label>
