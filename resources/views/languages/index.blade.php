            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body d-lg-flex align-items-lg-center justify-content-lg-between flex-lg-wrap">
                        ...
                        <div>
                            <a href="{{ route('languages.create', [], false) }}" class="btn btn-teal">
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap table-bordered">
                            <thead>
                                ...
                                <form action="{{ route('languages.index', [], false) }}" method="get">
                                    <tr>
                            ...
                            <td>{{ $model->is_active }}</td>
                                        ...
                                        <td>
                                            <div class="d-inline-flex gap-2">
                                                <a href="{{ route('languages.show', $model->id, false) }}"
                                                   class="btn btn-outline-info">
                                                    <i class="icon-eye8"></i>
                                                </a>
                                                <a href="{{ route('languages.edit', $model->id, false) }}"
